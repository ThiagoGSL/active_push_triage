...
def main():
    print("\nIniciando benchmark GPU (MuJoCo Warp) com 1024 envs...")
    num_envs_gpu = 1024
    ...
    print("\nIniciando benchmark GPU (MuJoCo Warp) com 4096 envs...")
    num_envs_gpu_4096 = 4096
    gpu_envs_4096, _ = make_warp_env(
        num_train=num_envs_gpu_4096,
        max_episode_steps=100,
        sparse_reward=False,
        n_substeps=40,
        seed=42,
    ...
    # Warmup e execucao GPU
    run_benchmark(gpu_envs_4096, 50) # warmup
    fps_gpu_4096 = run_benchmark(gpu_envs_4096, 200)
    gpu_envs_4096.close()
    print(f"FPS GPU Warp ({num_envs_gpu_4096} envs): {fps_gpu_4096:.2f}")
